...
## 🚀 Latest Features (v.1.1.5)

- **Dynamic Splash Screen**: Full system diagnostic and authorization sequence.
- **Ambient Audio Engine**: Improved Constant background hum (better loop and less noisy) using `SoX`.
- **Interactive Feedback**: Reactive sound effects for generic message and logout by "exit" command.
- **Automated Deployment**: Cross-distro installer for openSUSE, Fedora, Arch, and Debian/Ubuntu.

## 📦 Installation

1. git clone https://github.com/Citizen839X/MU-TH-UR-Terminal-Sounds.git
2. cd MU-TH-UR-Terminal-Sounds
3. chmod +x install_mother.sh
4. ./install_mother.sh
